...
|---|---|---|---|
| F-444-BIND | `CardanoKeri.singular_step_binding` | none | Equality between the released `Singular.step` result for the frozen escape fixture and the exact completion-only-custody error. |
