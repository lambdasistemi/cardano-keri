...
- [ ] T192-201 import exact production checkpoint/hash-proof/observer bytes
  with `#import_uplc`
...
- [ ] T192-206 publish builtin/preparation/solver-treatment facts without
  claiming uninterpreted crypto semantics
- [ ] T192-207 obtain PAIR RED/GREEN approval, accept the commit, rerun gate,
  stamp tasks, push, and refresh the PR
...
- [ ] T192-306 publish the durable `TRACTABILITY-RESULT`, including PASS/FAIL,
...
- [ ] T192-401 run the five frozen verification commands from a clean issue
...
- [ ] T192-403 verify PR linkage, labels, assignee, living body, pushed HEAD,
  and required CI; mark ready only when all are green
- [ ] T192-404 hand the exact commit and `TRACTABILITY-RESULT` to Epic #189
