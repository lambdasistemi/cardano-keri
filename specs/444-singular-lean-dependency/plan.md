...
5. Instrument layer: controls reject truncated Git outputs, conflicting README
   fields, a dirty consumed dependency, a wrong binding proposition, a custom
   axiom, and runner drift at a later command boundary.

## Ordered slice

- **S-444-BIND:** Complete R-444-PIN through R-444-DOCS in one local owner
